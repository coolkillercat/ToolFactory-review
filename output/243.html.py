...
def get_a_specific_armor_piece(idOrSlug):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
    # print(response.json())
get_a_specific_armor_piece(leather-headgear)
...
def get_a_specific_charm(idOrSlug):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
    # print(response.json())
get_a_specific_charm(poison-charm)
...
def get_a_specific_decoration(idOrSlug):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
    # print(response.json())
get_a_specific_decoration(antidote-jewel-1)
...
def get_a_specific_skill(idOrSlug):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
    # print(response.json())
get_a_specific_skill(poison-resistance)
...
def get_a_specific_weapon(idOrSlug):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
    # print(response.json())
get_a_specific_weapon(buster-sword-1)
