...
def submit_joke(formatVersion, category, type, joke, setup, delivery, flags, lang):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
    # print(response.json())
submit_joke(3, 'Misc', 'single', 'A horse walks into a bar...', 'What is a dying programmer's last program?', 'Goodbye, world!', {'nsfw': True, 'religious': False, 'political': True, 'racist': False, 'sexist': False, 'explicit': False}, 'en')
