...
def list_bulk_operation_items(
    ...
    api_url = 'http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7780/rest/default/V1/bulk'
    querystring = {
...
if __name__ == '__main__':
    r = list_bulk_operation_items(
        searchCriteria_filterGroups__0__filters__0__field_="""status""",
        searchCriteria_filterGroups__0__filters__0__value_="""completed""",
