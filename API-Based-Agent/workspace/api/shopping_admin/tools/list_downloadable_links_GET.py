...
def list_downloadable_links(sku=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7780/rest/default/V1/products/{quote(sku, safe='')}/downloadable-links"
    querystring = {
        'sku': sku,
    }
    headers = {
...
if __name__ == '__main__':
    r = list_downloadable_links(sku="""ABC123""")
    r_json = None
    try:
        r_json = r.json()
    except:
