...
def get_country_and_region_information(countryId=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7780/rest/default/V1/directory/countries/{quote(countryId, safe='')}"
    querystring = {
        'countryId': countryId,
    }
    headers = {
...
if __name__ == '__main__':
    r = get_country_and_region_information(countryId="""US""")
    r_json = None
    try:
        r_json = r.json()
    except:
