...
def get_operations_count_by_status(bulkUuid=None, status=None):
    ...
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/bulk/{quote(str(bulkUuid), safe='')}/operation-status/{quote(str(status), safe='')}"
    headers = {
