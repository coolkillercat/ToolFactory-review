...
def find_sources(
    ...
    api_url = 'http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/inventory/sources'
    querystring = {
...
if __name__ == '__main__':
    r = find_sources(
        ...
        searchCriteria_filterGroups__0__filters__0__value_="""value123""",
