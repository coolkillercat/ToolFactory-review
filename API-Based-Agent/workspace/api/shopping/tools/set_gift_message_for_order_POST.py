...
def set_gift_message_for_order(cartId=None):
    """
    Sets a gift message for an order.

    Args:
        cartId: The ID of the cart to set the gift message for.

    Returns:
        Response object from the API call.
    """
    api_url = f'http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/carts/{cartId}/gift-message'
    payload = {
        'gift_message': {
            'sender': 'Sender Name',
...
if __name__ == '__main__':
    r = set_gift_message_for_order(cartId=123)
    r_json = None
    try:
        r_json = r.json()
    except:
