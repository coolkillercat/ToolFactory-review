...
def retrieve_customer_groups(
    ...
    api_url = 'http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/customerGroups/search'
    querystring = {
...
if __name__ == '__main__':
    r = retrieve_customer_groups(
        searchCriteria_filterGroups__0__filters__0__field_="""group_name""",
        searchCriteria_filterGroups__0__filters__0__value_="""Retail""",
        searchCriteria_filterGroups__0__filters__0__conditionType_="""eq""",
        searchCriteria_sortOrders__0__field_="""group_id""",
