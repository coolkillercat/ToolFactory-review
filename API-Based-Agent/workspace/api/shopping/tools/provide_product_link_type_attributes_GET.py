...
def provide_product_link_type_attributes(type=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/products/links/{quote(type, safe='')}/attributes"
    querystring = {
        'type': type,
    }
    headers = {
...
if __name__ == '__main__':
    r = provide_product_link_type_attributes(type="""related""")
    r_json = None
    try:
        r_json = r.json()
    except:
