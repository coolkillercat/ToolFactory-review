...
def check_product_salability_for_requested_quantity(stockId=None, skuRequests_0__sku_=None, skuRequests_0__qty_=None):
...
if __name__ == '__main__':
    r = check_product_salability_for_requested_quantity(stockId=1, skuRequests_0__sku_='''SKU123''', skuRequests_0__qty_=10)
    r_json = None
    try:
        r_json = r.json()
    except:
