...
def get_latlng_from_address(address_country_=None, address_postcode_=None, address_street_=None, address_region_=None, address_city_=None):
...
if __name__ == '__main__':
    r = get_latlng_from_address(address_country_='''US''', address_postcode_='''10001''', address_street_='''123 Main St''', address_region_='''NY''', address_city_='''New York''')
    r_json = None
    try:
        r_json = r.json()
    except:
