...
if __name__ == '__main__':
    r = get_pickup_locations(searchRequest_area__radius_=10, searchRequest_area__searchTerm_='''store''', searchRequest_filters__country__value_='''US''', searchRequest_filters__country__conditionType_='''eq''', searchRequest_filters__postcode__value_='''10001''', searchRequest_filters__postcode__conditionType_='''eq''', searchRequest_filters__region__value_='''NY''', searchRequest_filters__region__conditionType_='''eq''', searchRequest_filters__regionId__value_='''1''', searchRequest_filters__regionId__conditionType_='''eq''', searchRequest_filters__city__value_='''New York''', searchRequest_filters__city__conditionType_='''eq''', searchRequest_filters__street__value_='''Main St''', searchRequest_filters__street__conditionType_='''eq''', searchRequest_filters__name__value_='''Store Name''', searchRequest_filters__name__conditionType_='''eq''', searchRequest_filters__pickupLocationCode__value_='''LOC123''', searchRequest_filters__pickupLocationCode__conditionType_='''eq''', searchRequest_pageSize_=20, searchRequest_currentPage_=1, searchRequest_scopeType_='''online''', searchRequest_scopeCode_='''channel123''', searchRequest_sort__0__field_='''name''', searchRequest_sort__0__direction_='''ASC''', searchRequest_extensionAttributes__productsInfo__0__sku_='''SKU123''')
    r_json = None
    try:
        r_json = r.json()
    except:
