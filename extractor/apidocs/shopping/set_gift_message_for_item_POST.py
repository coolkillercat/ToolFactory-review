...
def set_gift_message_for_item(cartId=None, itemId=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/guest-carts/{cartId}/gift-message/{itemId}"
...
if __name__ == '__main__':
    r = set_gift_message_for_item(cartId='''abc123''', itemId=1)
    r_json = None
    try:
        r_json = r.json()
    except:
