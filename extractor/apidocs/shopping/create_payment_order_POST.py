...
def create_payment_order(cartId=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/guest-carts/{cartId}/payment-order"
...
if __name__ == '__main__':
    r = create_payment_order(cartId='''abc123''')
    r_json = None
    try:
        r_json = r.json()
    except:
