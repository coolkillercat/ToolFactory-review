...
def get_payment_information(cartId=None):
    """
    Get payment information for a negotiable cart.
    
    Args:
        cartId (int or str): The ID of the cart to retrieve payment information for.
            Example: cartId=123, cartId='12345', cartId='cart123', cartId='guest123'
    ...
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/negotiable-carts/{quote(str(cartId), safe='')}/payment-information"
    headers = {
        "Content-Type": "application/json",
