...
def configure_u2f_key_provider(tfaToken=None):
    """
    ...
    """
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/tfa/u2fkey/configure"
...
if __name__ == '__main__':
    r = configure_u2f_key_provider(tfaToken='abc123')
    r_json = None
    try:
        r_json = r.json()
    except:
