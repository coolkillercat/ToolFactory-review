...
def get_all_stats(cursor=None, per_page=None, player_ids=None, game_ids=None, dates=None, seasons=None, postseason=None, start_date=None, end_date=None):
...
if __name__ == '__main__':
    r = get_all_stats(cursor=25, per_page=25, player_ids=[1, 2], game_ids=[1, 2], dates=['2024-01-01', '2024-01-02'], seasons=['2022', '2023'], postseason=False, start_date='2024-01-01', end_date='2024-01-31')
    r_json = None
    try:
        r_json = r.json()
    except:
