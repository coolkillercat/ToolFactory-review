...
def получение_динамики_ставок__валютный_своп_(date_req1=None, date_req2=None):
...
if __name__ == '__main__':
    r = получение_динамики_ставок__валютный_своп_(date_req1='''01/12/2002''', date_req2='''06/12/2002''')
    r_json = None
    try:
        r_json = r.json()
    except:
