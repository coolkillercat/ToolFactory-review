...
def получение_динамики_котировок_драгоценных_металлов(date_req1=None, date_req2=None):
...
if __name__ == '__main__':
    r = получение_динамики_котировок_драгоценных_металлов(date_req1='''01/07/2001''', date_req2='''13/07/2001''')
    r_json = None
    try:
        r_json = r.json()
    except:
