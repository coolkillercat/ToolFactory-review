...
def plain_text_response(text=None, add=None, fill_text='*', fill_char='*'):
...
if __name__ == '__main__':
    r = plain_text_response(text='''this is some test input''', add='''input''', fill_text='''[replaced]''', fill_char='''_''')
    r_json = None
    try:
        r_json = r.json()
    except:
