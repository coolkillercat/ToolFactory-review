...
def delete_email(f=None, ip=None, agent=None, email_ids=None):
    ...
    assert email_ids is not None, 'Missing required parameter: email_ids'
...
if __name__ == '__main__':
    r = delete_email(f='''del_email''', ip='''127.0.0.1''', agent='''Mozilla/5.0''', email_ids=[425, 426, 427])
    r_json = None
    try:
        r_json = r.json()
    except:
