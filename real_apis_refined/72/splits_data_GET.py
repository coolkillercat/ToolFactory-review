...
def splits_data(access_key=None, symbols=None, sort='DESC', date_from=None, date_to=None, limit=100, offset=None):
...
if __name__ == '__main__':
    r = splits_data(access_key="YOUR_ACCESS_KEY", symbols="AAPL,MSFT", sort="ASC", date_from="2020-05-21", date_to="2020-05-23", limit=50, offset=100)
    r_json = None
    try:
        r_json = r.json()
    except:
