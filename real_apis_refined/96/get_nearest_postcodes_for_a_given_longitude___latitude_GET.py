...
def get_nearest_postcodes_for_a_given_longitude___latitude(longitude=None, latitude=None):
...
if __name__ == '__main__':
    r = get_nearest_postcodes_for_a_given_longitude___latitude(longitude=0.629834723775309, latitude=51.7923246977375)
    r_json = None
    try:
        r_json = r.json()
    except:
