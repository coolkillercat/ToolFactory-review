...
def leave_a_table(sessionid=None, name=None):
    api_url = f"https://connect-four.p.rapidapi.com/api/{quote(sessionid, safe='')}/{quote(name, safe='')}/leave"
...
if __name__ == '__main__':
    r = leave_a_table(sessionid='''abc123''', name='''Player1''')
    r_json = None
    try:
        r_json = r.json()
    except:
