...
def create_tier_price(sku=None, customerGroupId=None, qty=None, price=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/products/{sku}/group-prices/{customerGroupId}/tiers/{qty}/price/{price}"
...
if __name__ == '__main__':
    r = create_tier_price(sku='''ABC123''', customerGroupId='''all''', qty=10, price=99.99)
    r_json = None
    try:
        r_json = r.json()
    except:
