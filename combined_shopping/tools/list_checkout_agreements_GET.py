...
if __name__ == '__main__':
    r = list_checkout_agreements(searchCriteria_filterGroups__0__filters__0__field_='''agreementId''', searchCriteria_filterGroups__0__filters__0__value_='''123''', searchCriteria_filterGroups__0__filters__0__conditionType_='''eq''', searchCriteria_sortOrders__0__field_='''createdAt''', searchCriteria_sortOrders__0__direction_='''ASC''', searchCriteria_pageSize_=10, searchCriteria_currentPage_=1)
    r_json = None
    try:
        r_json = r.json()
    except:
