...
def list_gift_wrappings(searchCriteria_filterGroups__0__filters__0__field_=None, searchCriteria_filterGroups__0__filters__0__value_=None, searchCriteria_filterGroups__0__filters__0__conditionType_=None, searchCriteria_sortOrders__0__field_=None, searchCriteria_sortOrders__0__direction_=None, searchCriteria_pageSize_=None, searchCriteria_currentPage_=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/gift-wrappings"
...
if __name__ == '__main__':
    r = list_gift_wrappings(searchCriteria_filterGroups__0__filters__0__field_='''name''', searchCriteria_filterGroups__0__filters__0__value_='''holiday''', searchCriteria_filterGroups__0__filters__0__conditionType_='''eq''', searchCriteria_sortOrders__0__field_='''price''', searchCriteria_sortOrders__0__direction_='''ASC''', searchCriteria_pageSize_=10, searchCriteria_currentPage_=1)
    r_json = None
    try:
        r_json = r.json()
    except:
