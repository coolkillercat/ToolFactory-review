...
def get_bundle_product_children(productSku=None, optionId=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/bundle-products/{quote(productSku, safe='')}/children"
    querystring = {'productSku': productSku, 'optionId': optionId, }
