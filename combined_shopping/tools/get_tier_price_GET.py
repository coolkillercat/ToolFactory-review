...
def get_tier_price(sku=None, customerGroupId=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/products/{quote(sku, safe='')}/group-prices/{quote(customerGroupId, safe='')}/tiers"
