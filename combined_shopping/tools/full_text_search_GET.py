...
if __name__ == '__main__':
    r = full_text_search(searchCriteria_requestName_='''product_search''', searchCriteria_filterGroups__0__filters__0__field_='''name''', searchCriteria_filterGroups__0__filters__0__value_='''laptop''', searchCriteria_filterGroups__0__filters__0__conditionType_='''like''', searchCriteria_sortOrders__0__field_='''price''', searchCriteria_sortOrders__0__direction_='''DESC''', searchCriteria_pageSize_=10, searchCriteria_currentPage_=1)
    r_json = None
    try:
        r_json = r.json()
    except:
