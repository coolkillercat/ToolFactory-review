...
def search_tax_rates(searchCriteria_filterGroups__0__filters__0__field_=None, searchCriteria_filterGroups__0__filters__0__value_=None, searchCriteria_filterGroups__0__filters__0__conditionType_=None, searchCriteria_sortOrders__0__field_=None, searchCriteria_sortOrders__0__direction_=None, searchCriteria_pageSize_=None, searchCriteria_currentPage_=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/taxRates/search"
...
if __name__ == '__main__':
    r = search_tax_rates(searchCriteria_filterGroups__0__filters__0__field_='''rate''', searchCriteria_filterGroups__0__filters__0__value_='''5%''', searchCriteria_filterGroups__0__filters__0__conditionType_='''gteq''', searchCriteria_sortOrders__0__field_='''rate''', searchCriteria_sortOrders__0__direction_='''DESC''', searchCriteria_pageSize_=20, searchCriteria_currentPage_=2)
    r_json = None
    try:
        r_json = r.json()
    except:
