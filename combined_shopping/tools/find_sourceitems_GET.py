...
if __name__ == '__main__':
    r = find_sourceitems(searchCriteria_filterGroups__0__filters__0__field_='''name''', searchCriteria_filterGroups__0__filters__0__value_='''value123''', searchCriteria_filterGroups__0__filters__0__conditionType_='''eq''', searchCriteria_sortOrders__0__field_='''created_at''', searchCriteria_sortOrders__0__direction_='''ASC''', searchCriteria_pageSize_=20, searchCriteria_currentPage_=1)
    r_json = None
    try:
        r_json = r.json()
    except:
