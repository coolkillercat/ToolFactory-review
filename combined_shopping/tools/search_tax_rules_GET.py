...
if __name__ == '__main__':
    r = search_tax_rules(searchCriteria_filterGroups__0__filters__0__field_='''rule_name''', searchCriteria_filterGroups__0__filters__0__value_='''VAT''', searchCriteria_filterGroups__0__filters__0__conditionType_='''like''', searchCriteria_sortOrders__0__field_='''priority''', searchCriteria_sortOrders__0__direction_='''ASC''', searchCriteria_pageSize_=15, searchCriteria_currentPage_=3)
    r_json = None
    try:
        r_json = r.json()
    except:
