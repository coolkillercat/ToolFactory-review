...
if __name__ == '__main__':
    r = list_invoices(searchCriteria_filterGroups__0__filters__0__field_='''status''', searchCriteria_filterGroups__0__filters__0__value_='''paid''', searchCriteria_filterGroups__0__filters__0__conditionType_='''eq''', searchCriteria_sortOrders__0__field_='''created_at''', searchCriteria_sortOrders__0__direction_='''DESC''', searchCriteria_pageSize_=10, searchCriteria_currentPage_=1)
    r_json = None
    try:
        r_json = r.json()
    except:
