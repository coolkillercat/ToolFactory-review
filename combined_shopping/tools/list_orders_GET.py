...
def list_orders(searchCriteria_filterGroups__0__filters__0__field_=None, searchCriteria_filterGroups__0__filters__0__value_=None, searchCriteria_filterGroups__0__filters__0__conditionType_=None, searchCriteria_sortOrders__0__field_=None, searchCriteria_sortOrders__0__direction_=None, searchCriteria_pageSize_=None, searchCriteria_currentPage_=None):
    api_url = f"http://ec2-3-129-135-45.us-east-2.compute.amazonaws.com:7770/rest/default/V1/orders"
...
if __name__ == '__main__':
    r = list_orders(searchCriteria_filterGroups__0__filters__0__field_='''status''', searchCriteria_filterGroups__0__filters__0__value_='''pending''', searchCriteria_filterGroups__0__filters__0__conditionType_='''eq''', searchCriteria_sortOrders__0__field_='''created_at''', searchCriteria_sortOrders__0__direction_='''ASC''', searchCriteria_pageSize_=20, searchCriteria_currentPage_=1)
    r_json = None
    try:
        r_json = r.json()
    except:
