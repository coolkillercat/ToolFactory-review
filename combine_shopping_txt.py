...
def combine_shopping_files():
    ...
    shopping_files = sorted(glob.glob('extractor/apidocs/shopping_*/shopping_*.txt'))
    
    # Initialize the combined data structure
    combined_data = {
        "title": "Combined Shopping API Documentation",
        "endpoints": []
    }
    ...
    output_path = 'combined_shopping/shopping_combined.txt'
...
def copy_tools():
    ...
    os.makedirs('combined_shopping/tools', exist_ok=True)
    
    # Find all Python tool files from all shopping directories
    tool_files = []
    for dir_path in glob.glob('extractor/apidocs/shopping_*'):
    ...
    for file_path in tool_files:
        ...
        destination = f'combined_shopping/tools/{file_name}'
    ...
    print(f"Copied {copied_count} tool files to combined_shopping/tools/")
...
def copy_config_file():
    ...
    config_path = 'combined_shopping/tools/.config'
